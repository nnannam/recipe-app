...
export default async function RecipePage( {params} ) {
    ...
    return (
        <div className="flex flex-col max-w-3x1 mx-auto p-6 bg-white rounded shadow">
            <Link href='/' className='text-blue-500 hover:underline mb-4'>Go Home</Link>

            <h1 className='text-2x1 font-bold mb-4'>{meal.strMeal}</h1>

            <img src={meal.strMealThumb} alt={meal.strMeal} 
            className='w-full h-auto rounded mb-4'/>

            <h6 className='mb-2 text-gray-700'><strong>Category:</strong></h6>
            <p className='mb-2 text-gray-700'><strong>Area:</strong></p>
